    ...
    for r2 in rows:
        if r1 != r2:
            ...
            for t in triangles:
                ...
                tr2_pt1 = landmarks_points2[index_pt1]
                tr2_pt2 = landmarks_points2[index_pt2]
                tr2_pt3 = landmarks_points2[index_pt3]
                ...
                if warped_triangle.shape[0] != mask_triangles_designed.shape[0] or warped_triangle.shape[1] != \
                        mask_triangles_designed.shape[1]:
                    warped_triangle = cv2.resize(warped_triangle,
                                                 (mask_triangles_designed.shape[1], mask_triangles_designed.shape[0]),
